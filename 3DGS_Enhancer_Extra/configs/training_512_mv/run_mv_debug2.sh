...
config_file=configs/${name}/config_mv_debug2.yaml

# save root dir for logs, checkpoints, tensorboard record, etc.
save_root="/workspace/results_train/dbg2"

mkdir -p $save_root/$name
HOST_GPU_NUM=1

## run
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 python3 -m torch.distributed.launch \
