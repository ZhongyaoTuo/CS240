...
expname="run1_relpose_dl3dv_3k_re10k_1k" 
config_file=configs/${name}/config_mv_run1_relpose_dl3dv_3k_re10k_1k.yaml

# save root dir for logs, checkpoints, tensorboard record, etc.
save_root="/workspace/results_train/run1_relpose_dl3dv_3k_re10k_1k"
